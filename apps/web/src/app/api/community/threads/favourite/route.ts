...
// /api/community/threads/favourite GET : Gets user favourite community threads
export async function GET(request: NextRequest): Promise<NextResponse<FavouriteThreadsCommunityGetResponse>> {
  try {
