  ...
  return (
    <section className="w-full" id="faq">
      <div className="bg-primary">
        <div className="mx-auto w-full max-w-5xl px-4 pt-10 md:px-20 md:pt-20 pb-10 md:pb-16 text-primary-foreground">
          <motion.h2
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-10 md:px-20">
        <Accordion className="space-y-4" type="single">
          {HOME_FAQ_QUESTIONS.map((question, index) => {
            ...
            return (
              <AccordionItem className="border bg-secondary/50 rounded-lg" key={key} value={key}>
