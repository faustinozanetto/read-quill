...
export type ClearFilterIconProps = BaseIconProps;

const ClearFilterIcon = forwardRef<SVGSVGElement, ClearFilterIconProps>(({ className, size, ...props }, ref) => {
  return (
    <svg
