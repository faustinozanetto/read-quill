...
export type SortAscIconProps = BaseIconProps;

export const SortAscIcon = forwardRef<SVGSVGElement, SortAscIconProps>(({ className, size, ...props }, ref) => (
  <svg
