...
export type NumberThreeIconProps = BaseIconProps;

export const NumberThreeIcon = forwardRef<SVGSVGElement, NumberThreeIconProps>(({ className, size, ...props }, ref) => (
  <svg
...
NumberThreeIcon.displayName = 'NumberThreeIcon';
