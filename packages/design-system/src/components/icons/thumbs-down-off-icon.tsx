...
export type ThumbsDownOffIconProps = BaseIconProps;

const ThumbsDownOffIcon = forwardRef<SVGSVGElement, ThumbsDownOffIconProps>(({ className, size, ...props }, ref) => {
  return (
    <svg
...
ThumbsDownOffIcon.displayName = 'ThumbsDownOffIcon';
